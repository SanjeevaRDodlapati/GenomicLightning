...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num-targets", type=int, default=919, help="Number of output targets"
    )
    ...
    # Hardware parameters
    parser.add_argument(
        "--devices", type=int, default=1, help="Number of GPUs to use (0 for auto)"
    )
    parser.add_argument(
        "--precision",
        type=int,
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="/home/sdodl001/genomic_results",

...
def format_workflow_info(run):
    ...
    commit_title = run.get('display_title', '')[:50] + "..." if len(run.get('display_title', '')) > 50 else run.get('display_title', '')
...
def monitor_workflows(duration_minutes=10):
    ...
    if time.time() >= end_time:
        ...
        print("Check manually at: https://github.com/SanjeevaRDodlapati/GenomicLightning/actions")
